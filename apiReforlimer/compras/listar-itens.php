...
$total_venda = 0;
$total_vendaF = 0;
$query_con = $pdo->query("SELECT ic.*, p.nome AS nome_produto, p.foto AS foto_produto, p.estoque AS estoque_produto
						  FROM itens_compra ic
						  LEFT JOIN produtos p ON p.id = ic.produto
						  WHERE ic.id_compra = 0 AND ic.usuario = '$id_usuario'
						  ORDER BY ic.id DESC");
