...
if($estoque + $quantidade < $quant){
$result = json_encode(array('mensagem'=>'Você não tem essa quantidade, você possui '.$estoque + $quantidade.' Produtos no estoque', 'sucesso'=>false));
echo $result;
...
$query = $pdo->query("UPDATE itens_venda SET quantidade = '$nova_quant', total = '$total' where id = '$id'");
